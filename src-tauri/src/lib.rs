...
fn show_main_window(app: tauri::AppHandle) -> Result<bool, String> {
    tray::hide_tray_popover(&app);
    tray::handle_tray_menu_event(&app, "show_main");
    Ok(true)
}

#[tauri::command]
fn hide_tray_popover(app: tauri::AppHandle) -> Result<bool, String> {
    tray::hide_tray_popover(&app);
    Ok(true)
}
            ...
            let mut tray_builder = TrayIconBuilder::with_id(tray::TRAY_ID)
                ...
                .on_tray_icon_event(|tray, event| match event {
                    TrayIconEvent::Click {
                        ...
                        crate::tray::handle_tray_menu_event(tray.app_handle(), "show_main");
                    }
                    TrayIconEvent::Click {
                        ...
                        crate::tray::toggle_tray_popover(tray.app_handle(), position);
                    }
