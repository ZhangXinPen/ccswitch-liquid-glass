...
function App() {
  ...
  return (
    <div
      className="relative flex flex-col h-screen overflow-hidden bg-transparent text-foreground selection:bg-cyan-400/30 pb-4"
          ...
          >
            {currentView !== "providers" ? (
              <div className="flex items-center gap-2">
                ...
                <h1 className="glass-title-pill px-4 py-2 text-lg font-[650]">
              ...
              <div className="flex items-center gap-2">
                <div className="glass-title-pill relative inline-flex items-center px-4 py-2">
                  <a
                    href="https://ccswitch.io"
                    target="_blank"
                    rel="noreferrer"
                    className={cn(
                      "brand-gradient-text text-xl font-bold transition-colors",
                      isProxyRunning && isCurrentAppTakeoverActive
                        ? "hue-rotate-[95deg]"
                        : "",
                    )}
                ...
                <Button
                  ...
                  className="glass-icon-button hover:bg-white/45 dark:hover:bg-white/10"
                >
                ...
                {isCurrentAppTakeoverActive && (
                  <Button
                    ...
                    className="hover:bg-white/45 dark:hover:bg-white/10"
                  >
              ...
              >
                ...
                {currentView === "providers" && (
                  <>
                    ...
                    <div className="glass-toolbar flex items-center gap-1 p-1.5">
                      <AnimatePresence mode="wait">
                        <motion.div
                          key={
                            activeApp === "openclaw"
                          ...
                          {activeApp === "hermes" ? (
                            <>
                              <Button
                                ...
                                className="text-muted-foreground hover:text-foreground hover:bg-white/45 dark:hover:bg-white/10 w-8 px-2"
