...
export function ProviderCard({
  ...
  return (
    <div
      className={cn(
        "glass-provider-card relative p-4 transition-all duration-200 ease-out",
    ...
    >
      ...
      <div className="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex flex-1 items-center gap-2">
          ...
          <div className="glass-icon-box h-10 w-10 flex items-center justify-center group-hover:scale-105 transition-transform duration-200">
            <ProviderIcon
              icon={provider.icon}
              name={provider.name}
          ...
          <div className="space-y-1">
            <div className="flex flex-wrap items-center gap-2 min-h-7">
              <h3 className="text-base font-[650] leading-none text-[var(--text-primary)] dark:text-foreground">
                {provider.name}
              </h3>
            ...
            {displayUrl && (
              <button
                ...
                className={cn(
                  ...
                  isClickableUrl
                    ? "text-[#0969f6] transition-colors hover:underline dark:text-blue-300 cursor-pointer"
          ...
          <div className="ml-auto">
            <div className="flex items-center gap-1">
              {isCopilot ? (
                ...
                <div className="flex items-center gap-2 text-xs text-[var(--text-secondary)] dark:text-gray-400">
              ...
              {hasMultiplePlans && (
                <button
                  ...
                  className="p-1 rounded-full hover:bg-white/50 dark:hover:bg-white/10 transition-colors text-gray-500 dark:text-gray-400 flex-shrink-0"
                  title={
                    isExpanded
