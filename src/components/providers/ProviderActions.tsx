...
export function ProviderActions({
  ...
  const iconButtonClass = "glass-icon-button h-8 w-8 p-1";
    ...
    if (isOmo) {
      if (isCurrent) {
        return {
          ...
          className:
            "bg-white/55 text-muted-foreground hover:bg-white/65 hover:text-muted-foreground dark:bg-white/10 dark:hover:bg-white/10",
    ...
    if (isAdditiveMode) {
      if (isInConfig) {
        return {
          ...
          variant: "secondary" as const,
          className: cn(
            "bg-orange-100/70 text-orange-600 hover:bg-orange-200/80 dark:bg-orange-900/50 dark:text-orange-300 dark:hover:bg-orange-900/70",
      ...
      return {
        disabled: false,
          variant: "default" as const,
          className:
          "border border-white/70 bg-gradient-to-br from-emerald-400 to-teal-600 shadow-lg shadow-emerald-500/20 dark:from-emerald-500 dark:to-teal-600",
    ...
    if (isFailoverMode) {
      if (isInFailoverQueue) {
        return {
          ...
          variant: "secondary" as const,
          className:
            "bg-blue-100/70 text-blue-600 hover:bg-blue-200/80 dark:bg-blue-900/50 dark:text-blue-300 dark:hover:bg-blue-900/70",
          icon: <Check className="h-4 w-4" />,
    ...
    <div className="flex items-center gap-1.5">
          ...
          return (
            <Button
              ...
              className={cn(
                "w-fit px-2.5",
                isDefaultModel
                  ? "bg-white/55 text-muted-foreground dark:bg-white/10 opacity-60 cursor-not-allowed"
                  : "glass-primary-button",
              )}
            >
      ...
      <div className="flex items-center gap-1">
        ...
        <Button
          ...
          className={cn(
            iconButtonClass,
            canDelete && "hover:text-red-500 hover:bg-red-500/10 dark:hover:text-red-300",
